<div>
    ...
    <div class="txt2">This account has been suspended due to none payment. Please clear any dues for reactivation</div>
    <div class="logo"><img src="{{ asset('../../assets/images/logo/logo.png') }}" width="200px"></div>
    <div id="orbit-system">
        <div class="system">
    ...
    <a href="mailto:info@shieldmaster.africa">
