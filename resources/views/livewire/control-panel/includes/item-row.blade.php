<tr>
    ...
    <td class="text-wrap">
        <small>{{ $modification->description }}</small>
    ...
    <td class="text-wrap">
        {{ $modification->approvals_count . ' / ' . $modification->approvers_required }}
    </td>

    <td class="text-wrap">
        {{ $modification->disapprovals_count . ' / ' . $modification->disapprovers_required }}
    </td>
